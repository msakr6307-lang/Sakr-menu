...
void installHooks() {
    ...
    NSLog(@"[MUSTAFA] Hooks installed! Base: 0x%lx", base);
}
...
- (void)setupFalconIcon {
    ...
    falconButton.layer.borderColor = [UIColor colorWithRed:1.0 green:0.84 blue:0 alpha:1.0].CGColor;
...
- (void)setupMenu {
    ...
    menuView.layer.borderColor = [UIColor colorWithRed:1.0 green:0.84 blue:0 alpha:1.0].CGColor;
    ...
    title.textColor = [UIColor colorWithRed:1.0 green:0.84 blue:0 alpha:1.0];
...
- (void)showTab:(NSString *)tab {
    ...
    if ([tab isEqualToString:@"WEAPON"]) {
        ...
        fovSlider.value = 100;
        fovSlider.tintColor = [UIColor colorWithRed:1.0 green:0.84 blue:0 alpha:1.0];
        ...
        UISegmentedControl *hitSegment = [[UISegmentedControl alloc] initWithItems:@[@"Head", @"Body"]];
        hitSegment.frame = CGRectMake(120, y, 145, 30);
        hitSegment.selectedSegmentIndex = 0;
        hitSegment.selectedSegmentTintColor = [UIColor colorWithRed:1.0 green:0.84 blue:0 alpha:1.0];
        [hitSegment addTarget:self action:@selector(changeHitLocation:) forControlEvents:UIControlEventValueChanged];
        [contentView addSubview:hitSegment];
    }
}
...
- (void)changeHitLocation:(UISegmentedControl *)segment {
    ...
    NSLog(@"[MUSTAFA] Hit location: %@", isHeadshot ? @"HEAD" : @"BODY");
}
